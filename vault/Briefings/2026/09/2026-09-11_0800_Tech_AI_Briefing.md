...
- 근거: [[News/b32e9b8471353987|Agents API, 긴 작업의 실행 관리를 서비스로 제공]] · [OpenAI 원문](https://openai.com/index/introducing-the-agents-api/)
...
- 근거: [[News/b8a75fb67d817922|GPT‑Live‑1, 듣고 말하는 음성 계층을 API로 제공]] · [OpenAI 원문](https://openai.com/index/introducing-gpt-live-1-in-the-api/)
- 누적 기록: [[Briefings/Topics/agent-runtime|에이전트의 실행 계층을 분리]]
...
- 근거: [[News/688d14b85e07a8db|GitHub Actions, 캐시 읽기와 쓰기 권한을 명시]] · [GitHub 원문](https://github.blog/changelog/2026-09-10-control-github-actions-cache-access-with-cache-mode/)
