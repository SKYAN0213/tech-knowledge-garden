...
- 근거: [[News/bab0e1718e7e0799|에이전트 샌드박스가 실패를 성공처럼 보이지 않게 했다]] · [NVIDIA 원문](https://docs.nvidia.com/nemoclaw/user-guide/pi/release-notes/2026/8/28)
...
- 근거: [[News/a0eed0f62d0dd240|TensorRT Model Connect가 체크포인트와 C++ 실행 사이를 묶었다]] · [NVIDIA 원문](https://developer.nvidia.com/blog/deploy-an-open-model-from-checkpoint-to-inference-in-two-commands-with-nvidia-tensorrt-model-connect/)
